        ...
        <div className="column intro__container blur-effect">
           <div className="header__info">
                ...
                <div className="header__info__middle">
                    ...
                    <p className="header__decription text__muted">I dissect intricate user experience challenges to engineer integrity-focused solutions that resonate with billions of users.</p>
                </div>
                <Facts/>
